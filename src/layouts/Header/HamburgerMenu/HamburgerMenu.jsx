...
export default function HamburgerMenu() {
    ...
    return (
        <>
            <button onClick={toggleSideBar} className="header-hamburger-btn" type="button" aria-label="open hamburger menu">
                <Hamburgericon className="icon header-hamburger-icon" alt="hamburger menu icon" loading="lazy"/>
            </button>
            {
                sidebarActive &&
                <>
