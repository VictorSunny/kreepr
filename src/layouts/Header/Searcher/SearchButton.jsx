...
function SearchButton() {
    ...
    return (
        <div className="search-btn-container">
            <button onClick={triggerSearchDialogue} className="search-btn"  type="button" aria-label="search">
            ...
            <div  id="floating-search-dialogue">
                <div id="search-dialogue-container">
                    <button onClick={triggerSearchDialogue} id="floating-search-dialogue-close-btn" type="button" aria-label="close search">
