            ...
            <div className="footer-section">
                ...
                <ul className="footer-links-container">
                    ...
                    <li className="footer-link-row">
                        <button className="btn footer-btn" type="button" aria-label="visit developer's linkedin">
                            <a target="_blank" rel="noopener noreferrer" className="btn-a contact-link" href="https://www.linkedin.com/in/victor-sunny-6b06ba220">
                                Linkedin
                    ...
                    <li className="footer-link-row">
                        <button className="btn footer-btn" type="button" aria-label="visit developer's github">
                            <a target="_blank" rel="noopener noreferrer" className="btn-a contact-link" href="https://www.github.com/victorsunny">
                                Github
                    ...
                    <li className="footer-link-row">
                        <button className="btn footer-btn" type="button" aria-label="send developer an email">
                            <a target="_blank" rel="noopener noreferrer" className="btn-a contact-link" href="mailto:victorsunny432@gmail.com">
                                Mail
                    ...
                    <li className="footer-link-row">
                        <button className="btn footer-btn" type="button" aria-label="visit developer's portfolio site">
                            <a target="_blank" rel="noopener noreferrer" className="btn-a contact-link" href="https://victorsunny.github.io">
                                Portfolio
                                <BriefcaseIcon className="icon footer-icon" style={{fill: 'white'}} loading="lazy"/>
                            </a>
                        </button>
                    </li>
                    <li className="footer-link-row">
                        <button className="btn footer-btn" type="button" aria-label="visit developer's discord">
                            <a target="_blank" rel="noopener noreferrer" className="btn-a contact-link" href="https://discordapp.com/users/1296969973155102761">
                                Discord
            ...
            <div className="footer-section">
                <div className="footer-sub-section">
                    ...
                    <div className="footer-links-container">
                        <a href="https://github.com" aria-label="visit site doc" target="_blank" rel="noopener noreferrer" className="link-btn footer-text-link">
                            ReadME
                        </a>
                    </div>
                </div>
                ...
                <div className="footer-sub-section">
                    ...
                    <div className="footer-links-container">
                        <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="link-btn footer-text-link">
                            Github Repo
                        </a>
                        <a href="https://victorsunny.github.io" aria-label="visit the developer's portfolio" target="_blank" rel="noopener noreferrer" className="link-btn footer-text-link">
        ...
        <>
            <div className="footer-section">
                ...
                <div className="footer-links-container">
                    ...
                    <Link to={'/all-coins'} className="link-btn footer-text-link" aria-label="go to coins page">
                         All Coins
                    </Link>
                    <Link to={'/about'} className="link-btn footer-text-link" type="button" aria-label="go to about page">
                         About
                    </Link>
                </div>
            </div>
