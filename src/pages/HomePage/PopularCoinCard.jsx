...
export default function PopularCoinCard({coin, id, index}) {
    ...
    const coinPastDayPriceChange = Number(coin.data.price_change_percentage_24h[preferredCurrency.value].toFixed(1)) 
    ...
    return (
        ...
        id={id}>
            ...
            <div className="popular-coin-meta popular-coin-card-section">
                ...
                <div className="popular-popular-coin-details">
            ...
            <div className="coin-history popular-coin-card-section">
                <div className="coin-sparkline-container">
                    <img src={coinSparkline} className="coin-sparkline" loading="auto" alt="coin sparkline"></img>
