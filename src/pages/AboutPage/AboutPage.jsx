    ...
    return (
        <div className="page-container about-page-container">
            ...
            <div className="about-introduction section">
                ...
                <p>
                    Kreepr is a website for cryptocurrency enthusiasts to find information on all relevant cryptocurrencies
                    in a simplified view.
                </p>
                <p>
                    Although built as a personal project by full-stack developer <a target="_blank" rel="noopener noreferrer" className="link-btn" href="https://www.linkedin.com/in/victor-sunny-6b06ba220">Victor Sunny</a>,
                    It is fully capable of offering useful value to visitors.
                </p>
                <p>
                    Keep up with all the latest cryptocurrencies, and get insights in the form of charts
                    with historic data going back up to 1 year ago
                </p>
                <p>
                    All cryptocurrencies' data are up to date, and powered by the very generous <a target="_blank" rel="noopener noreferrer" className="link-btn" href="https://www.coingecko.com"> Coingecko</a> API.
                </p>
            </div>
            ...
            <div className="about-technical-information section">
                ...
                <p>
                    The beautiful user interface of Kreepr is made possible with a combination of numerous frontend technologies including:
                </p>
                ...
                <div className="tech-stack-hero-section">
                    ...
                    <em>
                        Code edited in Visual Studio Code.
                    </em>
            ...
            <div className="section">
                ...
                <p>
                    User signup will be added in the nearest future to grant features such as
                    creation of watchlists, notifications, and more.
                    <br/>Will be powered by Django.
                </p>
            </div>
                ...
                imageList.map((image, index) => {
                    return (
                        <div key={index} className="hero-coin-flyer">
                            <img className="hero-icon" src={image.imageSource} loading="auto" alt={image.altText}></img>
                        </div>
                    )
                })
            }
