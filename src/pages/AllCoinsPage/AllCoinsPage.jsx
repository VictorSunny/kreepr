...
export default function AllCoinsPage() {
    ...
    if (isError && !isFetching) {
        return <div className="page-container"><ReloadSignal refreshActionName={"loading coins"} refreshClickFn={refetch} /></div>
    }
        ...
        <div className="page-container all-coins-page-container">
            ...
            <div className="coins-table-container">
                {/* coin table with "coinpages" data returned from api fetch and preferredcurrency context */}
                {
                    ...
                    <ScrollToTopButton />
                    <motion.button  className={`btn page-nav-btn ${isFetchingNextPage && 'loading'}`} type="button" aria-label="load more coins" onClick={fetchNextPage} layout>
