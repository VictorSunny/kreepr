          ...
          return page.map((coin, index) => {
            return (
              ...
              >
                ...
                <td>
                  <PercentChange
                    percentage={toOneDecimal(coin.price_change_percentage_1h_in_currency)}
                  />
                </td>
                <td>
                  <PercentChange
                    percentage={toOneDecimal(coin.price_change_percentage_24h_in_currency)}
                  />
                </td>
                <td>
                  <PercentChange
                    percentage={toOneDecimal(coin.price_change_percentage_7d_in_currency)}
                  />
                </td>
                <td>
                  <PercentChange
                    percentage={toOneDecimal(coin.price_change_percentage_30d_in_currency)}
                  />
                </td>
