...
export default function DropdownList({dropdownItems}) {
    ...
    const handleDropdownClick = (e) => {
        ...
        activeDropdownID != dropdownItemID ? setActiveDropdownID(dropdownItemID) : setActiveDropdownID(null);
    }
            ...
            <div className="dropdown-list-container">
                {
                    dropdownItems.map((dropdownObj, index) => {
                        return (
                            <div key={index}   className={`drop-list ${index == activeDropdownID && 'active-drop-list' || null}`}>
                                <button value={index} className="drop-list-btn" onClick={handleDropdownClick} type="button" aria-label="dropdown">
                                    {dropdownObj.heading}
                                </button>
