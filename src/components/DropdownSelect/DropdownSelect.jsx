...
export default function DropdownSelect({defaultValues, optionsValues, setContextValue, scrollToTop}) {
    ...
    return (
            <div className="dropdown-container">
                ...
                {dropdownIsActive && <Backdrop popoverDisplayState={dropdownIsActive} setPopoverDisplayState={setDropdownIsActive} />}
                ...
                <div className="dropdown-content">
                    ...
                    className="btn dropdown-btn" onClick={openCloseDropDown} type="button" aria-label="dropdown">
                        {defaultValues.text}
                    </button>
