...
function ErrorSignal() {
    ...
    return (
        <div className="reload-signal signal-modal">
            <SiteLogo />
            <div>
                <ErrorIcon className="signal-icon signal-action-response-icon" loading="eager" fetchPriority="high" alt="error image" />
                ...
                >
                    <button className="btn signal-btn" type="button" aria-label="go to homepage" onClick={goHome}>
                        Go Home
                    </button>
                    <button className="btn signal-btn" type="button" aria-label="try reload" onClick={refreshPage}>
                        Refresh
                    </button>
                </div>
            </div>
